 ...
 *    defeated. The check lives in `@ghostwire/security`, where a refusal can carry
 ...
 * they are composed in code (`@ghostwire/agent`'s prompt builder) where they are
...
export const ToolboxSchema = z.object({
  ...
  /** Must be digest-pinned. Validated in `@ghostwire/security`. */
