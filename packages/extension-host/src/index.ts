/**
 * @ghostbot/extension-host — third-party code, authorised and loaded.
 *
 ...
 * asks `@ghostbot/security` whether the bytes on disk are the ones an operator
 ...
 * package rather than a module in `@ghostbot/runtime`: an extension may
 * contribute a `ChannelFactory`, so something has to name `@ghostbot/channels`,
 ...
 *    `@ghostbot/security`'s `extension.ts`, and it is the difference between
