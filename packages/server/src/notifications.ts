 ...
 *
 * They live in this package rather than in `@ghostwire/core` for the same reason
...
import { rowReader, systemClock, type Clock, type Row } from '@ghostwire/core';
import { newUuid, type Notification } from '@ghostwire/protocol';
