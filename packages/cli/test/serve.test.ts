/**
 * `ghostai serve`, brought up for real.
 *
...
import type { Config, StatusResponse } from '@ghostwire/protocol';
...
describe('resolveUiRoot', () => {
  ...
  it('finds the bundle `@ghostwire/web` ships, and only when it has been built', () => {
