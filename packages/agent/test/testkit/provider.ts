 ...
 * `@ghostwire/providers`; nothing here is asserting anything about HTTP.
 *
...
import { assistantMessage } from '@ghostwire/core';
import type { ToolCall, Usage } from '@ghostwire/protocol';
import {
  emptyUsage,
  findProvider,
  type ChatProvider,
