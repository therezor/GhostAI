...
import type { ChatMessage, ContentPart, FilePart } from '@ghostwire/protocol';
import type { WorkspaceJail } from '@ghostwire/security';
import { formatBytes } from '@ghostwire/tools';
...
function locate(
  ...
  // channel `attach` port sketched in `@ghostwire/channels` will one day carry a
